...
namespace Soyo.SoyoRuntimeConsole.Samples.UsingOriginalStyledCommand
{
    ...
    public class DisplayController : MonoBehaviour
    {
        ...
        {
            _viewModel = new ConsoleViewModel(new CustomConsole());
        }
        ...
        private class DisplayControllerEditor : Editor
        {
            ...
            private void OnEnable()
            {
                _editorViewModel = serializedObject.targetObject is DisplayController dc
                    ? new ConsoleViewModel(new CustomConsole())
                    : null;
